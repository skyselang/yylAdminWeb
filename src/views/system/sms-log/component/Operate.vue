  ...
  >
    <el-scrollbar :height="height">
      <el-form ref="ref" label-width="120px">
        ...
        <el-form-item v-else-if="field === 'intcode'" :label="$t('国际码')">
          <el-input v-model="value" :placeholder="$t('请输入国际码')" clearable />
        </el-form-item>
        <el-form-item v-else-if="field === 'phone'" :label="$t('手机')">
          <el-input v-model="value" :placeholder="$t('请输入手机')" clearable />
        </el-form-item>
        <el-form-item v-else-if="field === 'template'" :label="$t('模板ID')">
          <el-input v-model="value" :placeholder="$t('请输入模板ID')" clearable />
        </el-form-item>
...
import { deleApi, updateApi, exportApi, importApi, clearApi } from '@/api/system/sms-log'
