  ...
  data() {
    return {
      ...
      query: {
        ...
        limit: getPageLimit(),
        search_mode: 'and',
        search: [{ field: 'phone', exp: 'like', value: '' }]
      },
      fields: []
    }
  },
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'intcode', name: this.$t('国际码'), exp: 'like' },
        { field: 'phone', name: this.$t('手机'), exp: 'like' },
        { field: 'template', name: this.$t('模板ID'), exp: 'like' },
        { field: 'data', name: this.$t('模板变量'), exp: 'like' },
        { field: 'content', name: this.$t('内容'), exp: 'like' },
