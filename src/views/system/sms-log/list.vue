<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="intcode" :label="$t('国际码')" min-width="80" sortable="custom" />
      <el-table-column prop="phone" :label="$t('手机')" min-width="120" sortable="custom" />
      <el-table-column prop="template" :label="$t('模板ID')" min-width="150" sortable="custom" />
...
import { listApi, deleApi } from '@/api/system/sms-log'
...
export default {
  ...
  data() {
    return {
      ...
      dialogTitle: '',
      basedata: { exps: [] },
      permInfo: 'admin/system.SmsLog/info',
      permEdit: 'admin/system.SmsLog/edit',
      permDele: 'admin/system.SmsLog/dele',
      routeInfo: 'SystemSmsLogInfo',
      routeAdd: 'SystemSmsLogAdd',
      routeEdit: 'SystemSmsLogEdit'
    }
  },
  created() {
    this.init()
