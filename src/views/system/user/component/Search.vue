...
export default {
  ...
  props: {
    ...
    basedata: {
      type: Object,
      default() {
        return { exps: [], depts: [], posts: [], roles: [], deptProps: {}, postProps: {} }
      }
    }
  },
  emits: ['search', 'reset'],
  data() {
    return {
      ...
      query: {
        ...
        limit: getPageLimit(),
        search_mode: 'and',
        search: [{ field: 'nickname', exp: 'like', value: '' }]
      },
      fields: []
    }
  },
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'nickname', name: this.$t('昵称'), exp: 'like' },
        { field: 'username', name: this.$t('账号'), exp: 'like' },
        { field: 'phone', name: this.$t('手机'), exp: 'like' },
        { field: 'email', name: this.$t('邮箱'), exp: 'like' },
        { field: 'dept_ids', name: this.$t('部门'), exp: 'in' },
        { field: 'post_ids', name: this.$t('职位'), exp: 'in' },
        { field: 'role_ids', name: this.$t('角色'), exp: 'in' },
        { field: 'is_super', name: this.$t('超管'), exp: '=' },
        { field: 'remark', name: this.$t('备注'), exp: 'like' },
