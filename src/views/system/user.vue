      ...
      >
        <el-form-item label="头像" prop="avatar_url">
          ...
          <el-col :span="12">
            ...
            <el-button @click="fileDelete('avatar')">删除</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      query: { page: 1, limit: getPageLimit(), search_field: 'username', search_exp: 'like', date_field: 'create_time' },
      data: [],
      count: 0,
      dialog: false,
      dialogTitle: '',
