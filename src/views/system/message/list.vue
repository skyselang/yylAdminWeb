...
import { listApi, deleApi } from '@/api/system/message'
...
export default {
  ...
  data() {
    return {
      ...
      dialogTitle: '',
      basedata: { exps: [], users: [] },
      permInfo: 'admin/system.Message/info',
      permEdit: 'admin/system.Message/edit',
      permDele: 'admin/system.Message/dele',
      routeInfo: 'SystemMessageInfo',
      routeAdd: 'SystemMessageAdd',
      routeEdit: 'SystemMessageEdit'
    }
  },
  created() {
    this.init()
