...
export default {
  ...
  props: {
    ...
    basedata: {
      type: Object,
      default() {
        return { exps: [], menu_types: [], log_types: [], trees: [], props: {} }
      }
    }
  },
  emits: ['search', 'reset'],
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'menu_pid', name: this.$t('上级'), exp: '=' },
        { field: 'menu_name', name: this.$t('名称'), exp: 'like' },
        { field: 'menu_url', name: this.$t('链接'), exp: 'like' },
        { field: 'path', name: this.$t('路由地址'), exp: 'like' },
        { field: 'name', name: this.$t('路由名称'), exp: 'like' },
        { field: 'component', name: this.$t('组件路径'), exp: 'like' },
        { field: 'menu_type', name: this.$t('类型'), exp: '=' },
        { field: 'is_unlogin', name: this.$t('免登'), exp: '=' },
        { field: 'is_unauth', name: this.$t('免权'), exp: '=' },
        { field: 'is_unrate', name: this.$t('免限'), exp: '=' },
        { field: 'hidden', name: this.$t('隐藏'), exp: '=' },
        { field: 'log_type', name: this.$t('日志类型'), exp: '=' },
        { field: 'meta_icon', name: this.$t('图标'), exp: '=' },
