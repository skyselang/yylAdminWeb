<template>
  <template v-for="(item, index) in [modelValue]" :key="index">
    ...
    <el-cascader
      ...
      class="w-full"
    />
    <el-select v-else-if="item.field === 'menu_type'" v-model="item.value">
      <el-option v-for="v in basedata.menu_types" :key="v.value" :value="v.value" :label="v.label" />
    </el-select>
