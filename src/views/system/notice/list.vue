...
import { listApi, deleApi } from '@/api/system/notice'
...
export default {
  ...
  data() {
    return {
      ...
      dialogTitle: '',
      basedata: { exps: [], types: [] },
      permInfo: 'admin/system.Notice/info',
      permEdit: 'admin/system.Notice/edit',
      permDele: 'admin/system.Notice/dele',
      routeInfo: 'SystemNoticeInfo',
      routeAdd: 'SystemNoticeAdd',
      routeEdit: 'SystemNoticeEdit'
    }
  },
  created() {
    this.init()
