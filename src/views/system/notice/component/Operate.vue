<template>
  <el-row>
    <el-col :span="6">
      <el-scrollbar-height>
        <el-button v-if="hasPerm(['admin/system.Notice/add'])" type="primary" @click="add()">
          {{ $t('添加') }}
        </el-button>
        ...
        <el-button v-if="hasPerm(['admin/system.Notice/dele'])" @click="update('is_delete')">
          {{ $t('删除') }}
        </el-button>
    ...
    <el-col :span="4">
      <el-scrollbar-height>
        <Exports
          v-if="hasPerm(['admin/system.Notice/export'])"
          :name="name"
          :api="exportApi"
          :query="query"
          :ids="ids"
