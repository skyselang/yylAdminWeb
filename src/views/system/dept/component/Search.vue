  ...
  data() {
    return {
      ...
      query: {
        ...
        limit: getPageLimit(),
        search_mode: 'and',
        search: [{ field: 'dept_name', exp: 'like', value: '' }]
      },
      fields: []
    }
  },
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'dept_unique', name: this.$t('编号'), exp: '=' },
        { field: 'dept_name', name: this.$t('名称'), exp: 'like' },
        { field: 'abbr', name: this.$t('简称'), exp: '=' },
        { field: 'tel', name: this.$t('电话'), exp: 'like' },
        { field: 'fax', name: this.$t('传真'), exp: 'like' },
        { field: 'email', name: this.$t('邮箱'), exp: 'like' },
        { field: 'addr', name: this.$t('地址'), exp: 'like' },
        { field: 'desc', name: this.$t('描述'), exp: 'like' },
