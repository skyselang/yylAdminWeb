  ...
  >
    <el-scrollbar :height="height">
      <el-form ref="ref" label-width="120px">
        ...
        <el-form-item v-else-if="field === 'dept_unique'" :label="$t('编号')">
        ...
        <el-form-item v-else-if="field === 'dept_pid'" :label="$t('上级')">
          <el-cascader
            v-model="value"
...
import { deleApi, disableApi, updateApi, exportApi, importApi } from '@/api/system/dept'
