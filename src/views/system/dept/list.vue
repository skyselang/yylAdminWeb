<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="dept_name" :label="$t('名称')" min-width="130" sortable="custom" />
      <el-table-column :prop="idkey" label="ID" width="80" sortable="custom" />
      <el-table-column prop="dept_unique" :label="$t('编号')" min-width="120" sortable="custom" />
...
import { listApi, deleApi, userListApi, userLiftApi } from '@/api/system/dept'
...
export default {
  ...
  data() {
    return {
      ...
      permInfo: 'admin/system.Dept/info',
      permAdd: 'admin/system.Dept/add',
      permEdit: 'admin/system.Dept/edit',
      permDele: 'admin/system.Dept/dele',
      permUser: 'admin/system.Dept/userList',
      routeInfo: 'SystemDeptInfo',
      routeAdd: 'SystemDeptAdd',
      routeEdit: 'SystemDeptEdit',
      expandAlled: false,
