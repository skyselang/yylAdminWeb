...
import { listApi, deleApi } from '@/api/system/user-message'
...
export default {
  ...
  data() {
    return {
      ...
      dialog: false,
      dialogTitle: '',
      basedata: { exps: [], users: [], messages: [] },
      permInfo: 'admin/system.UserMessage/info',
      permEdit: 'admin/system.UserMessage/edit',
      permDele: 'admin/system.UserMessage/dele',
      routeInfo: 'SystemUserMessageInfo',
      routeAdd: 'SystemUserMessageAdd',
      routeEdit: 'SystemUserMessageEdit'
    }
  },
  created() {
    this.init()
    ...
    list() {
      ...
      listApi(this.query)
        .then((res) => {
          ...
          this.basedata.messages = res.data.basedata.messages
        })
        .catch(() => {
          this.loading = false
        })
