<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="sender" :label="$t('发件人')" min-width="120" sortable="custom" />
      <el-table-column prop="recipient" :label="$t('收件人')" min-width="120" sortable="custom" />
      <el-table-column prop="theme" :label="$t('主题')" min-width="150" sortable="custom" />
      <el-table-column prop="error" :label="$t('错误')" min-width="120" sortable="custom" />
...
import { listApi, deleApi } from '@/api/system/email-log'
...
export default {
  ...
  data() {
    return {
      ...
      dialogTitle: '',
      basedata: { exps: [] },
      permInfo: 'admin/system.EmailLog/info',
      permEdit: 'admin/system.EmailLog/edit',
      permDele: 'admin/system.EmailLog/dele',
      routeInfo: 'SystemEmailLogInfo',
      routeAdd: 'SystemEmailLogAdd',
      routeEdit: 'SystemEmailLogEdit'
    }
  },
  created() {
    this.init()
