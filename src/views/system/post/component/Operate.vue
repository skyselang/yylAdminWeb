  ...
  >
    <el-scrollbar :height="height">
      <el-form ref="ref" label-width="120px">
        ...
        <el-form-item v-else-if="field === 'post_unique'" :label="$t('编号')">
        ...
        <el-form-item v-else-if="field === 'post_pid'" :label="$t('上级')">
          <el-cascader
            v-model="value"
        ...
        <el-form-item v-else-if="field === 'abbr'" :label="$t('简称')">
...
import { deleApi, disableApi, updateApi, exportApi, importApi } from '@/api/system/post'
