    ...
    <el-scrollbar :height="height">
      <el-row>
        <el-col :md="24" :lg="16" :xl="14">
          <el-form-item :label="$t('验证码开关')" prop="captcha_switch">
            <el-col :span="10">
              <ElSwitchOnoff v-model="model.captcha_switch" />
            </el-col>
            <el-col :span="14">
              <el-text size="default">{{ $t('开启后，后台登录需要输入验证码') }}</el-text>
            </el-col>
          </el-form-item>
...
import { captchaInfoApi as infoApi, captchaEditApi as editApi } from '@/api/system/setting'
