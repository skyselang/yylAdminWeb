...
import { listApi, deleApi } from '@/api/member/log'
...
export default {
  ...
  data() {
    return {
      ...
      permInfo: 'admin/member.Log/info',
      permEdit: 'admin/member.Log/edit',
      permDele: 'admin/member.Log/dele',
      routeInfo: 'MemberLogInfo',
      routeAdd: 'MemberLogAdd',
      routeEdit: 'MemberLogEdit'
    }
  },
  created() {
    this.init()
