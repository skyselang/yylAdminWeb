<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-row>
        <el-col>
          ...
          <el-button title="彻底删除" @click="selectOpen('dele')">删除</el-button>
          <el-button type="primary" @click="selectOpen('reco')">恢复</el-button>
        </el-col>
      </el-row>
      <el-dialog :title="selectTitle" :visible.sync="selectDialog" top="20vh" :close-on-click-modal="false" :close-on-press-escape="false">
        <el-form label-width="130px">
          ...
          <el-form-item v-else-if="selectType==='dele'" label="" prop="">
            <span style="color:red">确定要彻底删除选中的{{ name }}吗？</span>
          </el-form-item>
        </el-form>
    ...
    <el-table ref="table" v-loading="loading" :data="data" :height="height" @sort-change="sort" @selection-change="select">
      ...
      <el-table-column prop="delete_time" label="删除时间" min-width="160" sortable="custom" />
      <el-table-column label="操作" min-width="120" align="right" fixed="right">
        <template slot-scope="{ row }">
          <el-button size="mini" type="text" @click="selectOpen('reco', row)">恢复</el-button>
...
import { recover as list, info, add, edit, recoverDele as dele, region, repwd, disable, recoverReco } from '@/api/member/member'
