...
export default {
  ...
  props: {
    ...
    basedata: {
      type: Object,
      default() {
        return { exps: [], trees: [], props: {}, log_types: [] }
      }
    }
  },
  emits: ['search', 'reset'],
  data() {
    return {
      ...
      query: {
        ...
        limit: getPageLimit(),
        search_mode: 'and',
        search: [{ field: 'api_name', exp: 'like', value: '' }]
      },
      fields: []
    }
  },
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'api_pid', name: this.$t('上级'), exp: '=' },
        { field: 'api_name', name: this.$t('名称'), exp: 'like' },
        { field: 'api_url', name: this.$t('链接'), exp: 'like' },
        { field: 'api_type', name: this.$t('类型'), exp: '=' },
