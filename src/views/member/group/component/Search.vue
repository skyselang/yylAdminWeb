  ...
  data() {
    return {
      ...
      query: {
        ...
        limit: getPageLimit(),
        search_mode: 'and',
        search: [{ field: 'group_name', exp: 'like', value: '' }]
      },
      fields: []
    }
  },
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'group_unique', name: this.$t('编号'), exp: '=' },
        { field: 'group_name', name: this.$t('名称'), exp: 'like' },
        { field: 'desc', name: this.$t('描述'), exp: 'like' },
        { field: 'is_default', name: this.$t('默认'), exp: '=' },
