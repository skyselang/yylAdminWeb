...
export default {
  ...
  props: {
    ...
    basedata: {
      type: Object,
      default() {
        return { exps: [], tags: [], groups: [], regions: [], genders: [] }
      }
    }
  },
  emits: ['search', 'reset'],
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'username', name: this.$t('用户名'), exp: 'like' },
        { field: 'phone', name: this.$t('手机'), exp: 'like' },
        { field: 'email', name: this.$t('邮箱'), exp: 'like' },
        { field: 'gender', name: this.$t('性别'), exp: '=' },
        { field: 'region_id', name: this.$t('所在地'), exp: 'in' },
        { field: 'tag_ids', name: this.$t('标签'), exp: 'in' },
        { field: 'group_ids', name: this.$t('分组'), exp: 'in' },
