<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="username" :label="$t('用户名')" min-width="165" sortable="custom" />
...
import { listApi, deleApi } from '@/api/member/member'
...
export default {
  ...
  data() {
    return {
      ...
      permInfo: 'admin/member.Member/info',
      permEdit: 'admin/member.Member/edit',
      permDele: 'admin/member.Member/dele',
      routeInfo: 'MemberInfo',
      routeAdd: 'MemberAdd',
      routeEdit: 'MemberEdit'
    }
  },
  created() {
    this.init()
