...
export default {
  ...
  props: {
    ...
    basedata: {
      type: Object,
      default() {
        return { exps: [], platforms: [], applications: [] }
      }
    }
  },
  emits: ['search', 'reset'],
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'platform', name: this.$t('平台'), exp: '=' },
        { field: 'application', name: this.$t('应用'), exp: '=' },
        { field: 'member_id', name: this.$t('会员ID'), exp: '=' },
        { field: 'nickname', name: this.$t('昵称'), exp: 'like' },
        { field: 'unionid', name: 'unionid', exp: 'like' },
        { field: 'openid', name: 'openid', exp: 'like' },
