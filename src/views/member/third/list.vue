<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="nickname" :label="$t('昵称')" min-width="135" sortable="custom" />
      <el-table-column
...
import { listApi, deleApi } from '@/api/member/third'
...
export default {
  ...
  data() {
    return {
      ...
      dialog: false,
      dialogTitle: '',
      basedata: { exps: [], platforms: [], applications: [] },
      permInfo: 'admin/member.Third/info',
      permEdit: 'admin/member.Third/edit',
      permDele: 'admin/member.Third/dele',
      routeInfo: 'MemberThirdInfo',
      routeAdd: 'MemberThirdAdd',
      routeEdit: 'MemberThirdEdit'
    }
  },
  created() {
    this.init()
