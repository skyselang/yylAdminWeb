<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-row>
        <el-col>
          ...
          <el-cascader v-if="query.search_field==='api_id'" v-model="query.search_value" class="filter-item ya-search-value" placeholder="接口" :options="apiData" :props="apiProps" clearable filterable collapse-tags />
    ...
    <el-table ref="table" v-loading="loading" :data="data" :height="height" @sort-change="sort" @selection-change="select">
      ...
      <el-table-column prop="member_id" label="会员ID" min-width="70" />
      <el-table-column prop="username" label="会员昵称" min-width="100" show-overflow-tooltip />
