...
import { listApi, deleApi, memberListApi, memberLiftApi } from '@/api/member/tag'
...
export default {
  ...
  data() {
    return {
      ...
      dialogTitle: '',
      basedata: { exps: [] },
      permInfo: 'admin/member.Tag/info',
      permEdit: 'admin/member.Tag/edit',
      permDele: 'admin/member.Tag/dele',
      permMember: 'admin/member.Tag/memberList',
      routeInfo: 'MemberTagInfo',
      routeAdd: 'MemberTagAdd',
      routeEdit: 'MemberTagEdit',
      tag_id: 0,
      tag_name: ''
    }
  },
