...
import { listApi, deleApi } from '@/api/setting/feedback'
...
export default {
  ...
  data() {
    return {
      ...
      permInfo: 'admin/setting.Feedback/info',
      permEdit: 'admin/setting.Feedback/edit',
      permDele: 'admin/setting.Feedback/dele',
      routeInfo: 'SettingFeedbackInfo',
      routeAdd: 'SettingFeedbackAdd',
      routeEdit: 'SettingFeedbackEdit'
    }
  },
  created() {
    this.init()
