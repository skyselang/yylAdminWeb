...
export default {
  ...
  props: {
    ...
    basedata: {
      type: Object,
      default() {
        return { exps: [], trees: [], levels: [], props: {} }
      }
    }
  },
  emits: ['search', 'reset'],
  data() {
    return {
      ...
      query: {
        ...
        limit: getPageLimit(),
        search_mode: 'and',
        search: [{ field: 'region_name', exp: 'like', value: '' }]
      },
      fields: []
    }
  },
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'region_unique', name: this.$t('编号'), exp: '=' },
        { field: 'region_name', name: this.$t('名称'), exp: 'like' },
        { field: 'level', name: this.$t('级别'), exp: '=' },
        { field: 'pinyin', name: this.$t('拼音'), exp: '=' },
        { field: 'jianpin', name: this.$t('简拼'), exp: 'like' },
        { field: 'initials', name: this.$t('首字母'), exp: 'like' },
        { field: 'citycode', name: this.$t('区号'), exp: 'like' },
        { field: 'zipcode', name: this.$t('邮编'), exp: 'like' },
