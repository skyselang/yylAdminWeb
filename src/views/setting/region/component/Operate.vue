  ...
  >
    <el-scrollbar :height="height">
      <el-form ref="ref" label-width="120px">
        ...
        <el-form-item v-else-if="field === 'region_unique'" :label="$t('编号')">
        ...
        <el-form-item v-else-if="field === 'region_pid'" :label="$t('上级')">
          <el-cascader
            v-model="value"
        ...
        <el-form-item v-else-if="field === 'level'" :label="$t('级别')">
          <el-select v-model="value">
            <el-option v-for="item in basedata.levels" :key="item.value" :value="item.value" :label="item.name" />
          </el-select>
        </el-form-item>
        <el-form-item v-else-if="field === 'citycode'" :label="$t('区号')">
          <el-input v-model="value" clearable />
        </el-form-item>
        <el-form-item v-else-if="field === 'zipcode'" :label="$t('邮编')">
          <el-input v-model="value" clearable />
        </el-form-item>
        <el-form-item v-else-if="field === 'longitude'" :label="$t('经度')">
          <el-input v-model="value" clearable />
        </el-form-item>
        <el-form-item v-else-if="field === 'latitude'" :label="$t('纬度')">
          <el-input v-model="value" clearable />
        </el-form-item>
...
import { deleApi, disableApi, updateApi, exportApi, importApi } from '@/api/setting/region'
