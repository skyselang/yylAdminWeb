<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="type_name" :label="$t('类型')" min-width="65" column-key="type" />
...
import { listApi, deleApi } from '@/api/setting/notice'
...
export default {
  ...
  data() {
    return {
      ...
      dialogTitle: '',
      basedata: { exps: [], types: [] },
      permInfo: 'admin/setting.Notice/info',
      permEdit: 'admin/setting.Notice/edit',
      permDele: 'admin/setting.Notice/dele',
      routeInfo: 'SettingNoticeInfo',
      routeAdd: 'SettingNoticeAdd',
      routeEdit: 'SettingNoticeEdit'
    }
  },
  created() {
    this.init()
