<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="name" :label="$t('名称')" min-width="130" sortable="custom" />
...
import { listApi, deleApi } from '@/api/setting/accord'
...
export default {
  ...
  data() {
    return {
      ...
      dialogTitle: '',
      basedata: { exps: [] },
      permInfo: 'admin/setting.Accord/info',
      permEdit: 'admin/setting.Accord/edit',
      permDele: 'admin/setting.Accord/dele',
      routeInfo: 'SettingAccordInfo',
      routeAdd: 'SettingAccordAdd',
      routeEdit: 'SettingAccordEdit'
    }
  },
  created() {
    this.init()
