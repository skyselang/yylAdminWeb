...
import { listApi, deleApi, contentListApi, contentLiftApi } from '@/api/content/category'
...
export default {
  ...
  data() {
    return {
      ...
      permInfo: 'admin/content.Category/info',
      permAdd: 'admin/content.Category/add',
      permEdit: 'admin/content.Category/edit',
      permDele: 'admin/content.Category/dele',
      permContent: 'admin/content.Category/contentList',
      routeInfo: 'ContentCategoryInfo',
      routeAdd: 'ContentCategoryAdd',
      routeEdit: 'ContentCategoryEdit',
      expandAlled: false,
  ...
  methods: {
    ...
    // 内容
    content(row) {
      this.category_id = row[this.idkey]
