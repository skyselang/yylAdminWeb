  ...
  data() {
    return {
      ...
      query: {
        ...
        limit: getPageLimit(),
        search_mode: 'and',
        search: [{ field: 'category_name', exp: 'like', value: '' }]
      },
      fields: []
    }
  },
  ...
  methods: {
    ...
    searchField() {
      this.fields = [
        ...
        { field: 'category_pid', name: this.$t('上级'), exp: '=' },
        { field: 'category_unique', name: this.$t('编号'), exp: '=' },
        { field: 'category_name', name: this.$t('名称'), exp: 'like' },
        { field: 'title', name: this.$t('标题'), exp: '=' },
