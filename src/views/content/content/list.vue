...
import { listApi, deleApi } from '@/api/content/content'
...
export default {
  ...
  data() {
    return {
      ...
      permInfo: 'admin/content.Content/info',
      permEdit: 'admin/content.Content/edit',
      permDele: 'admin/content.Content/dele',
      routeInfo: 'ContentInfo',
      routeAdd: 'ContentAdd',
      routeEdit: 'ContentEdit'
    }
  },
  created() {
    this.init()
