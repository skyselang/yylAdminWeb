...
import { listApi, deleApi, fileListApi, fileLiftApi } from '@/api/file/group'
...
export default {
  ...
  data() {
    return {
      ...
      permInfo: 'admin/file.Group/info',
      permEdit: 'admin/file.Group/edit',
      permDele: 'admin/file.Group/dele',
      permFile: 'admin/file.Group/fileList',
      routeInfo: 'FileGroupInfo',
      routeAdd: 'FileGroupAdd',
      routeEdit: 'FileGroupEdit',
      group_id: 0,
      group_name: ''
    }
  },
