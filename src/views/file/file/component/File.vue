<template>
  ...
  >
    ...
    <el-row>
      <el-col :span="2">
        <el-button
          v-if="hasPerm(['admin/file.Group/fileLift', 'admin/file.Tag/fileLift'])"
          type="primary"
          @click="lift()"
        >
          {{ $t('解除') }}
    ...
    >
      ...
      <el-table-column prop="file_url" :label="$t('文件')" min-width="90">
      ...
      />
      <el-table-column prop="group_name" :label="$t('分组')" min-width="120" />
...
export default {
  ...
  data() {
    return {
      ...
      data: [],
      count: 0,
      query: { page: 1, limit: getPageLimit(), search: [{ field: 'file_name', exp: 'like', value: '' }] },
      ids: [],
      selectDialog: false,
      basedata: {
        exps: [],
