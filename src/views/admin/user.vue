<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-dialog :title="selectTitle" :visible.sync="selectDialog" top="20vh" :close-on-click-modal="false" :close-on-press-escape="false">
        <el-form ref="selectRef" label-width="120px">
          ...
          <el-form-item v-if="selectType==='password'" label="新密码" prop="password">
    ...
    <!-- 分配权限 -->
    <el-dialog :title="'分配权限：'+model[idkey]" :visible.sync="ruleDialog" top="5vh" :close-on-click-modal="false" :close-on-press-escape="false" destroy-on-close>
